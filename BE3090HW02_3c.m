...
figure;
hold on;
plot(x, inddists(1, :) / trapz(x, inddists(1, :)), 'g', "DisplayName", "end of b (24m)");
plot(x, inddists(12*30*10, :) / trapz(x, inddists(12*30*10, :)), 'g', "DisplayName", "b+12months (36m)");
plot(x, inddists((12+1)*30*10, :) /trapz(x, inddists((12+1)*30*10, :)) , "DisplayName", "b+12months+1day");
